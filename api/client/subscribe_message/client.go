...
// APIClient manages communication with the 微信公众号订阅消息相关接口 API v1.0.0
...
type APIClient struct {
	...
	SubscribemessageApi *SubscribemessageApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.SubscribemessageApi = (*SubscribemessageApiService)(&c.common)
